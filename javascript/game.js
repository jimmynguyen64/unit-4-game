$( document ).ready(function() {
    ...
    for (var i=0; i< number1.length; i++){
      ...
      imageCrystal1.attr('src', 'images\blue.png');
    ...
    for (var i=0; i< number2.length; i++){
      ...
      imageCrystal2.attr('src', 'images\kryptonian.png');
    ...
    for (var i=0; i< number3.length; i++){
      ...
      imageCrystal3.attr('src', 'images\power.png');
    ...
    for (var i=0; i< number4.length; i++){
      ...
      imageCrystal4.attr('src', 'images\turqious.png');
